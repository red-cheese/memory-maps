...
def gaussian3():
    """
    Locate and remove poisoned batches, and recalibrate after removing each bad batch.
    """
...
def gaussian4():
    """
    Experiment 4: assess quality of mmaps and other basic defenses, computing MC estimates.
    """
